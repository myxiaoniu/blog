...
<html>
  ...
  <body>
    ...
    <div class="x-body">
      <div class="layui-row">
        <form class="layui-form layui-col-md12 x-so" action="{{url('admin/name')}}" method="get">
      ...
      <xblock>
        ...
        <button class="layui-btn" onclick="x_admin_show('添加用户','{{url('admin/name/create')}}')"><i class="layui-icon"></i>添加</button>
      ...
      <table class="layui-table">
        ...
        <tbody>
          ...
          <tr>
            <td>
              <div class="layui-unselect layui-form-checkbox" lay-skin="primary" data-id='{{ $u->user_id }}'><i class="layui-icon">&#xe605;</i></div>
            </td>
            <td>{{$u->user_id}}</td>
            <td>{{$u->user_name}}</td>
            <td>{{$u->user_phone}}</td>
            ...
            <td class="td-manage">
              ...
              <a title="编辑"  onclick="x_admin_show('编辑','{{url('admin/name/'.$u->user_id.'/edit')}}')" href="javascript:;">
                <i class="layui-icon">&#xe642;</i>
              </a>
    ...
    <script>
      ...
      function member_del(obj,id){
          layer.confirm('确认要删除吗？',function(index){
              $.post('/admin/name/' + id, {"_method":"delete","_token":"{{csrf_token()}}"},function (data) {
                    // console.log(data);
                  if(data.status == 1){
